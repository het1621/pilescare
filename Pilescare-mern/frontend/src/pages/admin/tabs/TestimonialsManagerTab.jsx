...
import TestimonialContentTab from "./TestimonialContentTab";
  ...
  const save = async () => {
    ...
    try {
      editing === "new"
        ...
        : await api.patch(`/testimonials/${editing._id}`, form);
    ...
    <div className="max-w-6xl space-y-12 mt-6">
      ...
      <div className="pt-10 border-t border-brand-primary/10">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-serif text-brand-text font-medium">Testimonials List</h2>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {loading ? (
          <div className="md:col-span-2 p-12 text-center text-brand-textMuted">
          ...
          items.map((t) => (
            <div
              key={t._id}
              className="bg-white rounded-2xl border border-brand-primary/10 p-6"
            >
              ...
              <p className="text-sm text-brand-text leading-relaxed italic line-clamp-3">
                "{t.text}"
              </p>
